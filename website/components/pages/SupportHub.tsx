  ...
  if (!user) {
    return (
      <div className="space-y-6">
        <PageHeader
          title="Support"
          subtitle="Get help without signing in, or open a ticket you already started."
        />
        <div className="space-y-3">
          <Button href="/support/guest-claim" className="w-full" variant="secondary">
            I have a ticket number
          </Button>
          <Button href="/support/guest-new" className="w-full">
            Start a new ticket
          </Button>
          <Button href="/support/guest-chat" className="w-full" variant="ghost">
            Continue guest chat
          </Button>
        </div>
      </div>
